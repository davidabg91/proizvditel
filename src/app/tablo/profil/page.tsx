    ...
    <div>
      ...
      <ProfileForm
        initial={{
          ...
          urnDocumentUrl: producer.urnDocumentUrl ?? "",
          urnVerificationNote: producer.urnVerificationNote ?? "",
          ...
          hasShop: producer.hasShop,
          shopName: producer.shopName ?? "",
          shopAddress: producer.shopAddress ?? "",
          shopTown: producer.shopTown ?? "",
          shopRegion: producer.shopRegion ?? "",
          shopHours: producer.shopHours ?? "",
          shopPhone: producer.shopPhone ?? "",
          shopMapUrl: producer.shopMapUrl ?? "",
          shopNote: producer.shopNote ?? "",
          shopPhotoUrl: producer.shopPhotoUrl,
